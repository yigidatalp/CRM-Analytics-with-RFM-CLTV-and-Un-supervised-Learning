...
plt.xticks(rotation=90, ha='center')
plt.tight_layout()
plt.savefig('Box Plots before Outlier Handling 1a.pdf', dpi=250)
...
plt.xticks(rotation=90, ha='center')
plt.tight_layout()
plt.savefig('Box Plots before Outlier Handling 1b.pdf', dpi=250)
...
plt.xticks(rotation=90, ha='center')
plt.tight_layout()
plt.savefig('Box Plots before Outlier Handling 2a.pdf', dpi=250)
...
plt.xticks(rotation=90, ha='center')
plt.tight_layout()
plt.savefig('Box Plots before Outlier Handling 2b.pdf', dpi=250)
...
plt.xticks(rotation=90, ha='center')
plt.tight_layout()
plt.savefig('Box Plots before Outlier Handling 3a.pdf', dpi=250)
...
plt.xticks(rotation=90, ha='center')
plt.tight_layout()
plt.savefig('Box Plots before Outlier Handling 3b.pdf', dpi=250)
